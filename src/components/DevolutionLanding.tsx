      ...
      <main className="container mx-auto px-4 py-16 relative z-10 lg:px-16 mt-24">
        ...
        <PCWindow title="Join Us as a Speaker" className="mb-32">
          <p className="text-center mb-4">
            Share your knowledge and inspire the next generation of developers!
            Submit your talk proposal today.
          </p>
          <div className="text-center">
            <Button
              asChild
              className="bg-[#4ecdc4] text-[#1a1a1a] hover:bg-[#ff6b6b] text-lg px-8 py-4 rounded-none border-4 border-[#1a1a1a] transform hover:translate-x-2 hover:-translate-y-2 transition-transform shadow-neo">
